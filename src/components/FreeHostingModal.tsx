      ...
      <div className="relative w-full max-w-2xl glass-panel rounded-[32px] p-6 sm:p-8 max-h-[90vh] overflow-y-auto shadow-2xl border border-white/20 animate-scale-up">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h2 className="text-xl font-bold text-white">100% Free Lifetime Hosting</h2>
              ...
              <p className="text-xs text-slate-400">Zero database fees, zero server costs, 100% client persistent</p>
            </div>
          </div>
        ...
        <div className="space-y-6 text-slate-300 text-sm">
          ...
          <div className="p-4 rounded-2xl bg-white/[0.03] border border-white/10 flex items-start gap-3">
            ...
            <div>
              <h4 className="font-bold text-white text-sm mb-1">Why is this completely free?</h4>
          ...
          <div className="space-y-4">
            ...
            <div className="p-4 rounded-2xl bg-white/[0.02] border border-white/10 space-y-2">
              <div className="flex items-center justify-between">
                <span className="font-bold text-white text-sm">Option 1: Vercel (Recommended)</span>
              ...
              <ol className="list-decimal list-inside text-xs text-slate-400 space-y-1">
                ...
                <li>Go to <a href="https://vercel.com" target="_blank" rel="noreferrer" className="text-slate-200 underline">Vercel.com</a> and click <strong className="text-white">Import Project</strong>.</li>
                <li>Select your GitHub repository and click <strong className="text-white">Deploy</strong>. Your site is live instantly!</li>
              </ol>
            </div>
            ...
            <div className="p-4 rounded-2xl bg-white/[0.02] border border-white/10 space-y-2">
              <div className="flex items-center justify-between">
                ...
                <span className="text-[10px] font-bold text-slate-300 bg-white/10 px-2 py-0.5 rounded-full border border-white/20">Native</span>
              </div>
              <ol className="list-decimal list-inside text-xs text-slate-400 space-y-1">
                <li>Run <code className="bg-white/10 px-1.5 py-0.5 rounded text-slate-200">npm run build</code> in your terminal.</li>
                <li>In your GitHub repo settings, go to <strong className="text-white">Pages</strong>.</li>
            ...
            <div className="p-4 rounded-2xl bg-white/[0.02] border border-white/10 space-y-2">
              <div className="flex items-center justify-between">
                <span className="font-bold text-white text-sm">Option 3: Netlify / Cloudflare Pages</span>
                <span className="text-[10px] font-bold text-slate-300 bg-white/10 px-2 py-0.5 rounded-full border border-white/20">Unlimited Bandwidth</span>
              </div>
          ...
          <div className="p-4 rounded-2xl bg-white/[0.04] border border-white/10 flex items-center justify-between gap-3">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs text-slate-300">
                Use the <strong className="text-white">Export JSON</strong> button anytime to create instant backups of all your saved websites!
              </span>
            </div>
          </div>
