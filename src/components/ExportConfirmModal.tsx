      ...
      <div className="relative w-full max-w-md brutal-panel p-6 sm:p-8 animate-scale-up text-[#FEFFFC]">
        ...
        <div className="flex items-center justify-between gap-3 mb-6 pb-4 border-b-[4px] border-white/10">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 bg-[#FEFFFC]/10 border border-white/10 flex items-center justify-center text-[#FEFFFC] shadow-xl">
        ...
        {/* Details Box */}
        <div className="p-4 bg-[#FEFFFC]/10/40 backdrop-blur-md border border-white/10 shadow-xl mb-8 space-y-3">
          <div className="flex items-center gap-2 text-[#FEFFFC] text-xs font-black uppercase tracking-widest">
            <FileJson className="w-4 h-4" />
            <span>Target File: <code className="bg-[#FEFFFC]/10 text-[#FEFFFC] px-2 py-1 font-mono ml-1">STASH_AF_BACKUP.JSON</code></span>
          </div>
        ...
        {/* Actions */}
        <div className="flex items-center justify-end gap-4 pt-2 border-t-[4px] border-white/10 mt-2">
          <button
            onClick={onClose}
