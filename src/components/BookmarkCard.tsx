...
export const BookmarkCard: React.FC<BookmarkCardProps> = ({
  ...
  const getSourceBadge = (source: SourceType) => {
    const badgeStyle = "inline-flex items-center gap-1 px-1.5 py-0.5 bg-[#111111]/5/40 backdrop-blur-md border border-[#111111]/10 text-[#111111] text-[10px] font-black uppercase tracking-tight";
    switch (source) {
      case 'reddit':
    ...
    return (
      ...
      >
        <div className="flex items-center gap-4 min-w-0">
          <div className="w-10 h-10 bg-[#111111]/5/40 backdrop-blur-md border border-[#111111]/10 shadow-xl flex items-center justify-center shrink-0 p-1">
        ...
        <div className="flex items-center gap-1.5 shrink-0">
          <button
            ...
            className={`p-2 btn-brutal-stealth ${
              bookmark.isFavorite ? 'bg-[#111111]/5' : ''
            }`}
          >
            <Star className={`w-4 h-4 ${bookmark.isFavorite ? 'fill-[#FEFFFC] text-[#111111]' : 'text-[#111111]'}`} />
          </button>
  ...
  return (
    ...
    >
      <div>
        ...
        <div className="flex items-start justify-between gap-3 mb-4">
          <div className="flex items-center gap-3.5 min-w-0">
            <div className="w-12 h-12 bg-[#111111]/5/40 backdrop-blur-md border border-[#111111]/10 shadow-xl flex items-center justify-center p-2 shrink-0">
              {!imgError && bookmark.faviconUrl ? (
                <img
                  src={bookmark.faviconUrl}
                  alt=""
          ...
          <div className="flex items-center gap-1">
            <button
              ...
              className={`p-2 btn-brutal-stealth border ${
                bookmark.isFavorite ? 'bg-[#111111]/5 border-[#111111]/10' : 'border-transparent'
              }`}
            ...
            <button
              ...
              className="p-2 btn-brutal-stealth border border-transparent text-[#111111] hover:text-[#111111] hover:bg-[#111111]/5 hover:border-[#111111]/10 opacity-0 group-hover:opacity-100 "
              title="Delete entry"
            >
        ...
        <div className="flex flex-wrap gap-1.5 mb-5">
          {bookmark.tags.slice(0, 3).map((tag, idx) => (
            <span
              key={idx}
              className="px-2 py-0.5 bg-[#111111]/5/40 backdrop-blur-md border border-[#111111]/10 text-[10px] font-bold uppercase text-[#111111]"
            >
              #{tag}
            </span>
          ))}
      ...
      {/* Footer */}
      <div className="pt-4 border-t-[3px] border-[#111111]/10 flex items-center justify-between gap-3">
        <div className="flex items-center gap-1.5 bg-[#111111]/5 text-[#111111] px-3 py-1.5 shadow-xl">
          <Flame className="w-3 h-3 fill-[#FEFFFC] text-[#111111]" />
        ...
        <div className="flex items-center gap-1.5">
          <button
            onClick={handleCopy}
            className="p-1.5 btn-brutal-stealth border border-[#111111]/10 bg-[#111111]/5/40 backdrop-blur-md shadow-xl hover:translate-x-[-1px] hover:translate-y-[-1px] hover:shadow-xl"
            title="Copy URL"
          >
