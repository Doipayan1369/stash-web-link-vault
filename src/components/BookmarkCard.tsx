...
export const BookmarkCard: React.FC<BookmarkCardProps> = ({
  ...
  const getSourceBadge = (source: SourceType) => {
    const badgeStyle = "inline-flex items-center gap-1 px-1.5 py-0.5 bg-[#FEFFFC]/10/5/40 backdrop-blur-md border border-white/10/10 text-[#FEFFFC] text-[10px] font-black uppercase tracking-tight";
    switch (source) {
      case 'reddit':
    ...
    return (
      ...
      >
        <div className="flex items-center gap-4 min-w-0">
          <div className="w-10 h-10 bg-[#FEFFFC]/10/5/40 backdrop-blur-md border border-white/10/10 shadow-xl flex items-center justify-center shrink-0 p-1">
  ...
  return (
    ...
    >
      <div>
        ...
        <div className="flex items-start justify-between gap-3 mb-4">
          <div className="flex items-center gap-3.5 min-w-0">
            <div className="w-12 h-12 bg-[#FEFFFC]/10/5/40 backdrop-blur-md border border-white/10/10 shadow-xl flex items-center justify-center p-2 shrink-0">
              {!imgError && bookmark.faviconUrl ? (
                <img
                  src={bookmark.faviconUrl}
                  alt=""
        ...
        <div className="flex flex-wrap gap-1.5 mb-5">
          {bookmark.tags.slice(0, 3).map((tag, idx) => (
            <span
              key={idx}
              className="px-2 py-0.5 bg-[#FEFFFC]/10/5/40 backdrop-blur-md border border-white/10/10 text-[10px] font-bold uppercase text-[#FEFFFC]"
            >
              #{tag}
            </span>
          ))}
      ...
      {/* Footer */}
      <div className="pt-4 border-t-[3px] border-white/10/10 flex items-center justify-between gap-3">
        <div className="flex items-center gap-1.5 bg-[#FEFFFC]/10/5 text-[#FEFFFC] px-3 py-1.5 shadow-xl">
